...
class LLMService:
    ...
    def essay_feedback(self, grade: str, genre: str, topic: str, essay: str, user_key: str = "anonymous") -> Dict[str, Any]:
        ...
        try:
            ...
            resp = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": build_prompt(grade, genre, topic, essay)},
                ],
                timeout=30,
            )
